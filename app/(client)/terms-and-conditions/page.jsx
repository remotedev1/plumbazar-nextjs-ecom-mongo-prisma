...
const TermsAndConditions = () => {
  const terms = [
    ...
    "This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name plumbazar.com ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').",
    "The Platform is owned by BALAJI SANITARY, a company incorporated under the Companies Act, 1956 with its registered office at DOOR NO 20 3 241 11 12 WEST COAST COMPLEX MANGALURU NELLIKAI ROAD Mangalore India (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').",
    ...
    {
      title: "The use of Platform and/or availing of our Services is subject to the following Terms of Use:",
      subPoints: [
        ...
        "All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Mangalore, Karnataka.",
          ...
          typeof term === 'string' ? (
            ...
            <li key={index} className="text-justify">
              ...
              <ul className="list-disc ml-8">
                {term.subPoints.map((subpoint, subIndex) => (
